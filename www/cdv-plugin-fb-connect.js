...
FBConnect.prototype.init = function(apiKey, fail) {
  ...
  FBConnect.prototype.login = function(params, cb, fail) {
    params = params || { scope: '' };
  ...
  FBConnect.prototype.logout = function(cb, fail) {
  ...
  FBConnect.prototype.getLoginStatus = function(cb, fail) {
    cordova.exec(function(e) {
      if (cb) cb(e);
    }, (fail?fail:null), 'FacebookConnectPlugin', 'getLoginStatus', []);
  };

  FBConnect.prototype.dialog = function(params, cb, fail) {
    cordova.exec(function(e) { // login
      if (cb) cb(e);
